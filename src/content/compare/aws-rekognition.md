...
Normalized honestly: our metered lane is ≈16¢/camera-hour at 30 fps (≈0.5¢ at 1 fps)† — versus $6/hr for one Rekognition detector, $0.49/hr for grandfathered streaming, ~$0.06/hr for offline Nova. Against the detector and streaming rows we're now cheaper per raw hour; offline Nova batch remains cheaper than our 30 fps rate (though not our low-fps rates). If a fixed detector or an offline batch answer genuinely solves your problem, weigh those rows. But none of them include the thing our meter prices: a live, deterministic, evidenced answer to *your* question. Fleets and 24/7 estates still belong on the enterprise lane.
